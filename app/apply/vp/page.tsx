      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-10">
          <div className="inline-block mb-4 px-4 py-1.5 bg-purple-500/10 border border-purple-500/30 rounded-full">
            <span className="text-xs font-semibold tracking-widest uppercase text-purple-400">
              VP Partner Application
            </span>
          </div>
          <h1 className="text-3xl md:text-4xl font-light text-white mb-3">
            Join the <span className="text-purple-400">Elite VP Partner</span> Tier
          </h1>
          <p className="text-white/60">Earn 25-35% commissions with dedicated support and exclusive benefits</p>
        </div>
        ...
        <div className="bg-purple-500/5 border border-purple-500/20 rounded-xl p-6 mb-8">
          <h3 className="text-sm font-semibold text-purple-400 uppercase tracking-wider mb-4">
            VP Partner Requirements
          </h3>
          <ul className="space-y-2 text-white/70 text-sm">
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 shrink-0" />
              Established audience or network (5,000+ contacts recommended)
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 shrink-0" />
              Professional online presence (LinkedIn, website, or social media)
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 shrink-0" />
              Affiliate marketing experience preferred
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 shrink-0" />
              Commitment to monthly promotion and sub-affiliate recruitment
            </li>
          </ul>
          <p className="text-white/40 text-xs mt-4">
            Applications are reviewed within 24-48 hours. Limited positions available.
          </p>
        </div>

        {/* Form Card */}
        <div className="bg-[#111] border border-white/10 rounded-2xl p-8">
          <h2 className="text-lg font-medium text-white mb-6">VP Partner Application Form</h2>
          <p className="text-white/50 text-sm mb-8">Complete application with additional qualification information</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* VP Qualification */}
            <div>
              <h3 className="text-sm font-medium text-white/70 mb-4 uppercase tracking-wider">VP Qualification</h3>
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="linkedinUrl" className="text-white/70">
                ...
                <div className="space-y-2">
                  <Label htmlFor="websiteUrl" className="text-white/70">
                ...
                <div className="space-y-2">
                  <Label htmlFor="monthlyReach" className="text-white/70">
                    Estimated Monthly Reach *
                  </Label>
                  <Select
                    value={formData.monthlyReach}
                    onValueChange={(v) => setFormData({ ...formData, monthlyReach: v })}
                  >
                    <SelectTrigger className="bg-[#1a1a1a] border-white/10 text-white">
                      <SelectValue placeholder="Select your reach..." />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="5k-10k">5,000 - 10,000 contacts</SelectItem>
                      <SelectItem value="10k-25k">10,000 - 25,000 contacts</SelectItem>
                      <SelectItem value="25k-50k">25,000 - 50,000 contacts</SelectItem>
                      <SelectItem value="50k+">50,000+ contacts</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="whyVP" className="text-white/70">
                    Why are you interested in the VP Partner tier? *
                  </Label>
                  <Textarea
                    id="whyVP"
                    required
                    ...
                    placeholder="Tell us about your experience and why you'd be a great VP Partner..."
                  />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-white/30 text-xs">Required for all VP Partners for tax compliance</p>
                </div>
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-purple-400 hover:from-purple-600 hover:to-purple-500 text-white py-6 text-base font-semibold rounded-xl"
            >
              {isSubmitting ? (
                <>
